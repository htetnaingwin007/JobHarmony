...
@section('content')
    ...
    <div class="container-fluid px-4">
            <div class="my-3">
                ...
                <a href="{{ route('backend.joblocation.create') }}" class="btn btn-primary float-end" >
                    Create 
                </a>
                ...
                <table class="table table-bordered" id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{route('backend.joblocation.edit',$joblocation->id)}}" class="btn btn-sm btn-warning me-2">Edit</a>
    ...
    <script>
        $(document).ready(function(){
            $('tbody').on('click','.delete',function(){
                ...
                let id = $(this).data('id');
                // console.log(id);
                $('#deleteForm').attr('action',`joblocation/${id}`);
