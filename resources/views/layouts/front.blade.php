...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('front-assets/css/custom-bs.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('front-assets/fonts/line-icons/style.css')}}">
...
<div class="site-wrap">
    ...
    <script src="{{asset('front-assets/js/stickyfill.min.js')}}"></script>
